                ...
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel3Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                            ...
                            .addComponent(tradeCombo, 0, 126, Short.MAX_VALUE))
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
...
int realId;
   ...
   private void moduleShow() {
    ...
    public void LookUp() {
        ...
        String query = "SELECT LUID,TRADE.TRADENAME,levels.LEVEL,modules.ModuleName,Unit,LU_NAME FROM learningunits JOIN trade USING(TRADEID) JOIN levels USING(LEVELID)JOIN modules USING(MCODE) WHERE TRADENAME=? AND LEVEL=? LIMIT 100";
        try {
   ...
   public String GenerateLU() {
        ...
        try {
            String sql = "SELECT COUNT(LUID) AS NUMBERS,TRADE.TRADENAME,levels.LEVEL,modules.ModuleName,Unit,LU_NAME FROM learningunits JOIN trade USING(TRADEID) JOIN levels USING(LEVELID)JOIN modules USING(MCODE) WHERE TRADENAME=? AND LEVEL=? AND ModuleName=?";
            pst = conn.prepareStatement(sql);
            pst.setString(1, trad);
            pst.setString(2,levl);
